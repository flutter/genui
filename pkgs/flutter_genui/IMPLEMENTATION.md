...
graph TD
    ...
    subgraph "flutter_genui Package"
        ...
        AiClient["AiClient<br>(e.g., FirebaseAiClient)"]
...
- **`FirebaseAiClient`**: The default implementation of `AiClient`. It handles the complexities of interacting with the Gemini API, including model configuration, retry logic with exponential backoff, and tool management. It supports two main generation modes:
