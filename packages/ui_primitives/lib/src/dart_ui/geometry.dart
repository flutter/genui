  ...
  static Offset? lerp(Offset? a, Offset? b, double t) {
    if (b == null) {
      ...
      if (a == null) {
        ...
        return Offset(
          lerpDoubleNonNull(a.dx, b.dx, t),
          lerpDoubleNonNull(a.dy, b.dy, t),
        );
      }
    }
  }
  ...
  static Size? lerp(Size? a, Size? b, double t) {
    if (b == null) {
      ...
      if (a == null) {
        ...
        return Size(
          lerpDoubleNonNull(a.width, b.width, t),
          lerpDoubleNonNull(a.height, b.height, t),
        );
      }
    }
  }
  ...
  static Rect? lerp(Rect? a, Rect? b, double t) {
    if (b == null) {
      ...
      if (a == null) {
        ...
        return Rect.fromLTRB(
          lerpDoubleNonNull(a.left, b.left, t),
          lerpDoubleNonNull(a.top, b.top, t),
          lerpDoubleNonNull(a.right, b.right, t),
          lerpDoubleNonNull(a.bottom, b.bottom, t),
        );
      }
    }
  }
  ...
  static Radius? lerp(Radius? a, Radius? b, double t) {
    if (b == null) {
      ...
      if (a == null) {
        ...
        return Radius.elliptical(
          lerpDoubleNonNull(a.x, b.x, t),
          lerpDoubleNonNull(a.y, b.y, t),
        );
      }
    }
  }
...
abstract class _RRectLike<T extends _RRectLike<T>> {
  ...
  T _lerpTo(T? b, double t) {
    ...
    if (b == null) {
      ...
      return _create(
        left: lerpDoubleNonNull(left, b.left, t),
        top: lerpDoubleNonNull(top, b.top, t),
        right: lerpDoubleNonNull(right, b.right, t),
        bottom: lerpDoubleNonNull(bottom, b.bottom, t),
        tlRadiusX: math.max(0, lerpDoubleNonNull(tlRadiusX, b.tlRadiusX, t)),
        tlRadiusY: math.max(0, lerpDoubleNonNull(tlRadiusY, b.tlRadiusY, t)),
        trRadiusX: math.max(0, lerpDoubleNonNull(trRadiusX, b.trRadiusX, t)),
        trRadiusY: math.max(0, lerpDoubleNonNull(trRadiusY, b.trRadiusY, t)),
        brRadiusX: math.max(0, lerpDoubleNonNull(brRadiusX, b.brRadiusX, t)),
        brRadiusY: math.max(0, lerpDoubleNonNull(brRadiusY, b.brRadiusY, t)),
        blRadiusX: math.max(0, lerpDoubleNonNull(blRadiusX, b.blRadiusX, t)),
        blRadiusY: math.max(0, lerpDoubleNonNull(blRadiusY, b.blRadiusY, t)),
      );
    }
  }
