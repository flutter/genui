...
class TaskStatusUpdateEvent implements StreamingEvent {
  const TaskStatusUpdateEvent({this.kind = 'task_status_update', required this.taskId, required this.contextId, required this.status, @JsonKey(name: 'final') this.final_ = false});
