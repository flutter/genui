...
///
/// Publicly this still consumes the legacy [SurfaceContext.definition] API.
/// When the context is GenUI's own internal [LiveSurfaceContext], the renderer
/// additionally uses the live core surface model for per-component granular
/// rebuilds.
...
class _SurfaceState extends State<Surface> {
  ...
  /// Recursively builds a widget from the live core model.
  ...
  /// Recursively builds a widget from the legacy snapshot model.
