...
/// The implicit flow.
 OAuthFlow? get implicit;/// The password flow.
 OAuthFlow? get password;/// The client credentials flow.
 OAuthFlow? get clientCredentials;/// The authorization code flow.
...
/// The authorization URL for the flow.
 String? get authorizationUrl;/// The token URL for the flow.
 String? get tokenUrl;/// The refresh URL for the flow.
 String? get refreshUrl;/// The available scopes for the flow.
