...
StreamingEvent _$StreamingEventFromJson(Map<String, Object?> json) {
  switch (json['kind']) {
    ...
    case 'task_artifact_update':
      return TaskArtifactUpdateEvent.fromJson(json);

    default:
      throw CheckedFromJsonException(json, 'kind', 'StreamingEvent',
...
mixin _$StreamingEvent {
  ...
  $StreamingEventCopyWith<StreamingEvent> get copyWith =>
      _$StreamingEventCopyWithImpl<StreamingEvent>(
...
abstract mixin class $StreamingEventCopyWith<$Res> {
  factory $StreamingEventCopyWith(
          StreamingEvent value, $Res Function(StreamingEvent) _then) =
      _$StreamingEventCopyWithImpl;
  @useResult
...
extension StreamingEventPatterns on StreamingEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(TaskStatusUpdateEvent value)? taskStatusUpdate,
    TResult Function(TaskArtifactUpdateEvent value)? taskArtifactUpdate,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case TaskStatusUpdateEvent() when taskStatusUpdate != null:
        return taskStatusUpdate(_that);
      case TaskArtifactUpdateEvent() when taskArtifactUpdate != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(TaskStatusUpdateEvent value) taskStatusUpdate,
    required TResult Function(TaskArtifactUpdateEvent value) taskArtifactUpdate,
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(String kind, String taskId, String contextId,
            TaskStatus status, bool final_)?
        taskStatusUpdate,
    TResult Function(String kind, String taskId, String contextId,
            Artifact artifact, bool append, bool lastChunk)?
        taskArtifactUpdate,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case TaskStatusUpdateEvent() when taskStatusUpdate != null:
        return taskStatusUpdate(_that.kind, _that.taskId, _that.contextId,
            _that.status, _that.final_);
      case TaskArtifactUpdateEvent() when taskArtifactUpdate != null:
        return taskArtifactUpdate(_that.kind, _that.taskId, _that.contextId,
            _that.artifact, _that.append, _that.lastChunk);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String kind, String taskId, String contextId,
            TaskStatus status, bool final_)
        taskStatusUpdate,
    required TResult Function(String kind, String taskId, String contextId,
            Artifact artifact, bool append, bool lastChunk)
...
class TaskStatusUpdateEvent implements StreamingEvent {
  const TaskStatusUpdateEvent(
      {this.kind = 'task_status_update',
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TaskStatusUpdateEventCopyWith<TaskStatusUpdateEvent> get copyWith =>
      _$TaskStatusUpdateEventCopyWithImpl<TaskStatusUpdateEvent>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TaskStatusUpdateEvent &&
            (identical(other.kind, kind) || other.kind == kind) &&
            (identical(other.taskId, taskId) || other.taskId == taskId) &&
            (identical(other.contextId, contextId) ||
                other.contextId == contextId) &&
            (identical(other.status, status) || other.status == status) &&
            (identical(other.final_, final_) || other.final_ == final_));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, kind, taskId, contextId, status, final_);
...
/// @nodoc
abstract mixin class $TaskStatusUpdateEventCopyWith<$Res>
    implements $StreamingEventCopyWith<$Res> {
  factory $TaskStatusUpdateEventCopyWith(TaskStatusUpdateEvent value,
          $Res Function(TaskStatusUpdateEvent) _then) =
      _$TaskStatusUpdateEventCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String kind,
...
class _$TaskStatusUpdateEventCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(TaskStatusUpdateEvent(
      ...
      final_: null == final_
          ? _self.final_
          : final_ // ignore: cast_nullable_to_non_nullable
              as bool,
    ));
  }
...
class TaskArtifactUpdateEvent implements StreamingEvent {
  const TaskArtifactUpdateEvent(
      {this.kind = 'task_artifact_update',
      required this.taskId,
      required this.contextId,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TaskArtifactUpdateEventCopyWith<TaskArtifactUpdateEvent> get copyWith =>
      _$TaskArtifactUpdateEventCopyWithImpl<TaskArtifactUpdateEvent>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TaskArtifactUpdateEvent &&
            (identical(other.kind, kind) || other.kind == kind) &&
            (identical(other.taskId, taskId) || other.taskId == taskId) &&
            (identical(other.contextId, contextId) ||
                other.contextId == contextId) &&
  ...
  int get hashCode => Object.hash(
      runtimeType, kind, taskId, contextId, artifact, append, lastChunk);
...
/// @nodoc
abstract mixin class $TaskArtifactUpdateEventCopyWith<$Res>
    implements $StreamingEventCopyWith<$Res> {
  factory $TaskArtifactUpdateEventCopyWith(TaskArtifactUpdateEvent value,
          $Res Function(TaskArtifactUpdateEvent) _then) =
      _$TaskArtifactUpdateEventCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String kind,
