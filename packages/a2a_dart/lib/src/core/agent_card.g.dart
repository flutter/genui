...
_AgentCard _$AgentCardFromJson(Map<String, Object?> json) => _AgentCard(
      ...
      preferredTransport: $enumDecodeNullable(
          _$TransportProtocolEnumMap, json['preferredTransport']),
  ...
  securitySchemes: (json['securitySchemes'] as Map<String, Object?>?)?.map(
        (k, e) =>
            MapEntry(k, SecurityScheme.fromJson(e as Map<String, Object?>)),
      ),
...
Map<String, Object?> _$AgentCardToJson(
  _AgentCard instance,
      ...
      'url': instance.url,
      'preferredTransport':
          _$TransportProtocolEnumMap[instance.preferredTransport],
      'additionalInterfaces':
          instance.additionalInterfaces?.map((e) => e.toJson()).toList(),
