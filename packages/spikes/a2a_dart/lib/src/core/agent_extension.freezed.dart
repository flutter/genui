...
@useResult
$Res call({
 String uri, String? description, bool? required, Map<String, dynamic>? params
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uri,  String? description,  bool? required,  Map<String, dynamic>? params)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AgentExtension() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uri,  String? description,  bool? required,  Map<String, dynamic>? params)  $default,) {final _that = this;
switch (_that) {
case _AgentExtension():
return $default(_that.uri,_that.description,_that.required,_that.params);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uri,  String? description,  bool? required,  Map<String, dynamic>? params)?  $default,) {final _that = this;
switch (_that) {
case _AgentExtension() when $default != null:
return $default(_that.uri,_that.description,_that.required,_that.params);case _:
  return null;
...
class _AgentExtension implements AgentExtension {
  const _AgentExtension({required this.uri, this.description, this.required, final  Map<String, dynamic>? params}): _params = params;
