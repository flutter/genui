...
/// responses.
 bool? get streaming;/// Indicates if the agent supports sending push notifications for asynchronous
/// task updates.
 bool? get pushNotifications;/// Indicates if the agent provides a history of state transitions for a task.
