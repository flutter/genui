...
mixin _$Part {
 ...
 String get kind; Map<String, dynamic>? get metadata;
...
@useResult
$Res call({
 String kind, Map<String, dynamic>? metadata
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String kind,  String text,  Map<String, dynamic>? metadata)?  text,TResult Function( String kind,  FileWithUri file,  Map<String, dynamic>? metadata)?  file,TResult Function( String kind,  Map<String, dynamic> data,  Map<String, dynamic>? metadata)?  data,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TextPart() when text != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String kind,  String text,  Map<String, dynamic>? metadata)  text,required TResult Function( String kind,  FileWithUri file,  Map<String, dynamic>? metadata)  file,required TResult Function( String kind,  Map<String, dynamic> data,  Map<String, dynamic>? metadata)  data,}) {final _that = this;
switch (_that) {
case TextPart():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String kind,  String text,  Map<String, dynamic>? metadata)?  text,TResult? Function( String kind,  FileWithUri file,  Map<String, dynamic>? metadata)?  file,TResult? Function( String kind,  Map<String, dynamic> data,  Map<String, dynamic>? metadata)?  data,}) {final _that = this;
switch (_that) {
case TextPart() when text != null:
return text(_that.kind,_that.text,_that.metadata);case FilePart() when file != null:
return file(_that.kind,_that.file,_that.metadata);case DataPart() when data != null:
...
class TextPart implements Part {
  const TextPart({this.kind = 'text', required this.text, final  Map<String, dynamic>? metadata}): _metadata = metadata;
...
class FilePart implements Part {
  const FilePart({this.kind = 'file', required this.file, final  Map<String, dynamic>? metadata}): _metadata = metadata;
...
as FileWithUri,metadata: freezed == metadata ? _self._metadata : metadata // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
...
class DataPart implements Part {
  const DataPart({this.kind = 'data', required final  Map<String, dynamic> data, final  Map<String, dynamic>? metadata}): _data = data,_metadata = metadata;
...
/// A URL pointing to the file's content.
 String get uri;/// An optional name for the file (e.g., "document.pdf").
 String? get name;/// The MIME type of the file (e.g., "application/pdf").
 String? get mimeType;
/// Create a copy of FileWithUri
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FileWithUriCopyWith<FileWithUri> get copyWith => _$FileWithUriCopyWithImpl<FileWithUri>(this as FileWithUri, _$identity);
...
/// Create a copy of FileWithUri
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uri = null,Object? name = freezed,Object? mimeType = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FileWithUri value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FileWithUri value)  $default,){
final _that = this;
switch (_that) {
case _FileWithUri():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FileWithUri value)?  $default,){
final _that = this;
switch (_that) {
case _FileWithUri() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uri,  String? name,  String? mimeType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FileWithUri() when $default != null:
return $default(_that.uri,_that.name,_that.mimeType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uri,  String? name,  String? mimeType)  $default,) {final _that = this;
switch (_that) {
case _FileWithUri():
return $default(_that.uri,_that.name,_that.mimeType);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uri,  String? name,  String? mimeType)?  $default,) {final _that = this;
switch (_that) {
case _FileWithUri() when $default != null:
return $default(_that.uri,_that.name,_that.mimeType);case _:
  return null;
...
class _FileWithUri implements FileWithUri {
  ...
  factory _FileWithUri.fromJson(Map<String, dynamic> json) => _$FileWithUriFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$FileWithUriCopyWith<_FileWithUri> get copyWith => __$FileWithUriCopyWithImpl<_FileWithUri>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FileWithUri&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.name, name) || other.name == name)&&(identical(other.mimeType, mimeType) || other.mimeType == mimeType));
}
...
/// @nodoc
abstract mixin class _$FileWithUriCopyWith<$Res> implements $FileWithUriCopyWith<$Res> {
  factory _$FileWithUriCopyWith(_FileWithUri value, $Res Function(_FileWithUri) _then) = __$FileWithUriCopyWithImpl;
@override @useResult
$Res call({
 String uri, String? name, String? mimeType
});
...
/// @nodoc
class __$FileWithUriCopyWithImpl<$Res>
    implements _$FileWithUriCopyWith<$Res> {
