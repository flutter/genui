...
/// a new task.
 String get id;/// A server-generated unique identifier (e.g. UUID) for maintaining context
/// across multiple related tasks or interactions.
 String get contextId;/// The current status of the task, including its state and a descriptive
/// message.
 TaskStatus get status;/// An array of messages exchanged during the task, representing the
/// conversation history.
 List<Message>? get history;/// A collection of artifacts generated by the agent during the execution of
/// the task.
 List<Artifact>? get artifacts;/// Optional metadata for extensions. The key is an extension-specific
/// identifier.
 Map<String, dynamic>? get metadata;/// The type of this object, used as a discriminator. Always 'task' for a Task.
 String get kind;
...
@useResult
$Res call({
 String id, String contextId, TaskStatus status, List<Message>? history, List<Artifact>? artifacts, Map<String, dynamic>? metadata, String kind
});
...
as Map<String, dynamic>?,kind: null == kind ? _self.kind : kind // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of Task
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String contextId,  TaskStatus status,  List<Message>? history,  List<Artifact>? artifacts,  Map<String, dynamic>? metadata,  String kind)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Task() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String contextId,  TaskStatus status,  List<Message>? history,  List<Artifact>? artifacts,  Map<String, dynamic>? metadata,  String kind)  $default,) {final _that = this;
switch (_that) {
case _Task():
return $default(_that.id,_that.contextId,_that.status,_that.history,_that.artifacts,_that.metadata,_that.kind);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String contextId,  TaskStatus status,  List<Message>? history,  List<Artifact>? artifacts,  Map<String, dynamic>? metadata,  String kind)?  $default,) {final _that = this;
switch (_that) {
case _Task() when $default != null:
return $default(_that.id,_that.contextId,_that.status,_that.history,_that.artifacts,_that.metadata,_that.kind);case _:
  return null;
...
class _Task implements Task {
  const _Task({required this.id, required this.contextId, required this.status, final  List<Message>? history, final  List<Artifact>? artifacts, final  Map<String, dynamic>? metadata, this.kind = 'task'}): _history = history,_artifacts = artifacts,_metadata = metadata;
...
/// current status.
 Message? get message;/// An ISO 8601 datetime string indicating when this status was recorded.
...
/// task.
 ...
 String? get name;/// An optional, human-readable description of the artifact.
 String? get description;/// An array of content parts that make up the artifact.
 List<Part> get parts;/// Optional metadata for extensions. The key is an extension-specific
/// identifier.
 Map<String, dynamic>? get metadata;/// The URIs of extensions that are relevant to this artifact.
...
@useResult
$Res call({
 String artifactId, String? name, String? description, List<Part> parts, Map<String, dynamic>? metadata, List<String>? extensions
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String artifactId,  String? name,  String? description,  List<Part> parts,  Map<String, dynamic>? metadata,  List<String>? extensions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Artifact() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String artifactId,  String? name,  String? description,  List<Part> parts,  Map<String, dynamic>? metadata,  List<String>? extensions)  $default,) {final _that = this;
switch (_that) {
case _Artifact():
return $default(_that.artifactId,_that.name,_that.description,_that.parts,_that.metadata,_that.extensions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String artifactId,  String? name,  String? description,  List<Part> parts,  Map<String, dynamic>? metadata,  List<String>? extensions)?  $default,) {final _that = this;
switch (_that) {
case _Artifact() when $default != null:
return $default(_that.artifactId,_that.name,_that.description,_that.parts,_that.metadata,_that.extensions);case _:
  return null;
...
class _Artifact implements Artifact {
  const _Artifact({required this.artifactId, this.name, this.description, required final  List<Part> parts, final  Map<String, dynamic>? metadata, final  List<String>? extensions}): _parts = parts,_metadata = metadata,_extensions = extensions;
