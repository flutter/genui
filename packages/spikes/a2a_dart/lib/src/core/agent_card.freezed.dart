...
/// The version of the A2A protocol this agent supports.
 ...
 String get name;/// A short description of the agent's purpose and capabilities.
 String get description;/// A URL for the agent's website or relevant documentation.
 String get url;/// The preferred transport protocol for this agent.
 TransportProtocol? get preferredTransport;/// A list of additional interfaces the agent supports.
 List<AgentInterface>? get additionalInterfaces;/// A URL for an icon representing the agent.
 String? get iconUrl;/// Information about the agent's provider.
 AgentProvider? get provider;/// The version of the agent's software.
 String get version;/// A URL for the agent's detailed documentation.
 String? get documentationUrl;/// The capabilities of the agent.
 AgentCapabilities get capabilities;/// The security schemes supported by the agent.
 Map<String, SecurityScheme>? get securitySchemes;/// The security requirements for the agent.
 List<Map<String, List<String>>>? get security;/// The default input modes for the agent.
 List<String> get defaultInputModes;/// The default output modes for the agent.
 List<String> get defaultOutputModes;/// The skills supported by the agent.
 List<AgentSkill> get skills;/// Whether the agent supports authenticated extended card requests.
