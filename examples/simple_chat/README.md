...
1. **Configure Firebase**: Follow the instructions in the main `genui` package [README.md](../../packages/genui/README.md) to add Firebase to your Flutter app. You will need to:
