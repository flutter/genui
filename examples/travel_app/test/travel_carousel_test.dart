              ...
              body: Builder(
                builder: (context) {
                  return catalogItem.widgetBuilder(
                    ...
                    buildChild: (id) => Image.network('https://example.com/$id.jpg'), // Not used in this widget
              ...
              body: Builder(
                builder: (context) {
                  return catalogItem.widgetBuilder(
                    ...
                    buildChild: (id) => Image.network('https://example.com/$id.jpg'),
                    dispatchEvent: mockDispatchEvent,
                    context: context,
                  );
                },
