...
- **Dynamic UI State Management**: The `Conversation` and `SurfaceController` from `genui` handle the orchestration of AI interaction, state of the dynamically generated UI surfaces, and event processing.
