                ...
                "properties": {
                  "Text": {
                    ...
                    "properties": {
                      ...
                      "hint": {
                        "type": "string",
                        "description": "A hint for the text style. One of:\n- `h1`: Largest heading.\n- `h2`: Second largest heading.\n- `h3`: Third largest heading.\n- `h4`: Fourth largest heading.\n- `h5`: Fifth largest heading.\n- `caption`: Small text for captions.\n- `body`: Standard body text.",
                        "enum": [
                          "h1",
                          "h2",
                          "h3",
                  ...
                  "Button": {
                    ...
                    "properties": {
                      ...
                      "primary": {
                        "type": "boolean",
                        "description": "Whether or not this button is the 'primary' button for the UI it is connected to. Reserved for submit buttons, or similar, that define an important action. Secondary buttons (e.g. cancel buttons) should not have this set to true. There should only be one primary button among a group of related buttons."
                      },
                      "action": {
                        "type": "object",
