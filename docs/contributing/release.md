...
Make sure each releasable dart package is released (TODO: [auto-create P0 bug](https://github.com/dart-lang/ecosystem/issues/423))
   ...
   1.2. For packages not yet published, publish them by running `flutter pub publish` (if you do not have permissions, ask in the team chat to be made an admin on the admin page of the package). TODO: switch to tagging after [the fix](https://github.com/dart-lang/ecosystem/issues/418%20)

**Potential improvements for the process:**

* Broken publishing: https://github.com/dart-lang/ecosystem/issues/418 
* Wip links are not actionable: https://github.com/dart-lang/ecosystem/issues/421 
* Validate package are release-ready: https://github.com/dart-lang/ecosystem/issues/422 
* Publishable versions should be published: https://github.com/dart-lang/ecosystem/issues/423
